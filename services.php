...
<head>
	...
	<title>Guy J Price - Artist</title>
...
<body>
	...
	<?php include 'includes/services/portraits.php' ; ?>
        
        <?php include 'includes/services/pets.php' ; ?>
        
        <div id="commissions">
        <?php include 'includes/services/commissions.php' ; ?>
        </div>
        
	<div id="property">
        <?php include 'includes/services/property.php' ; ?>
        </div>
